        ...
        <div class="row">
          <div class="col-lg-4 d-flex align-items-stretch">
            <div class="content">
              ...
              <p>
                Nuestra misión es el cuidado de tu sonrisa
              </p>
              <center>
                <img src="assets/img/diente.png" class="img-hero">
              </center>
            </div>
          </div>
     ...
     <section id="about" class="about">
      ...
      <div class="container">
        ...
        <div class="section-title">
          <h2>Servicios</h2>
          <p>Aquí estan algunos de los servicios que ofrecemos para ti</p>
        </div>
 ...
 <section id="doctors" class="doctors">
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Contáctanos</h2>
          <p>Si deseas agendar una cita, envía tu información en el siguiente formulario
            para contactarte, o comunícate con nosotros directamente.
          </p>
        </div>
      </div>
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
            ...
            <form action="" method="post" role="form" class="php-email-form">
              ...
              <div class="form-group mt-3">
                <textarea class="form-control" name="message" rows="5" placeholder="Si deseas agregar algún mensaje, escríbelo aquí..." required></textarea>
              </div>
              <div class="my-3">
